    ...
    $.fn.inputSpinner = function (methodOrProps) {
        ...
        var props = {
            ...
            template: // the template of the input
                ...
                '<button style="min-width: ${buttonsWidth};background-color:#660000;color: white;" class="btn btn-decrement ${buttonsClass} btn-minus" type="button">${decrementButton}</button>' +
                '<input type="text" inputmode="decimal" style="text-align: ${textAlign}" class="form-control form-control-text-input"/>' +
                '<button style="min-width: ${buttonsWidth};background-color:#660000;color: white;" class="btn btn-increment ${buttonsClass} btn-plus" type="button">${incrementButton}</button>' +
                '</div>'
        }
